...
export default function SearchPage() {
  ...
  const handleSwapCities = () => {
    ...
    // If search was already submitted, search again automatically with swapped cities
    if (submittedParams) {
      setSubmittedParams({
  ...
  // Sort and filter results locally
  ...
  return (
    <div className="flex flex-col gap-8 max-w-4xl mx-auto">
      ...
      <div className="text-center py-6">
        <h1 className="mb-3 text-4xl font-extrabold tracking-tight sm:text-5xl bg-gradient-to-r from-blue-400 via-indigo-200 to-indigo-400 bg-clip-text text-transparent">
      ...
      <div className="glass-panel rounded-2xl p-6 sm:p-8 shadow-2xl relative border-white/5">
        ...
        <div className="flex justify-center sm:justify-start gap-2 mb-6 border-b border-white/5 pb-5 overflow-x-auto">
          {[
            { id: "", label: "All Modes", icon: "🌐" },
            { id: "BUS", label: "Bus", icon: "🚌" },
            { id: "TRAIN", label: "Train", icon: "🚆" },
            { id: "AIRPLANE", label: "Flight", icon: "✈️" },
          ].map((mode) => (
            <button
              key={mode.id}
              type="button"
        ...
        <form onSubmit={handleSearch} className="flex flex-col gap-6">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-7 items-end">
            ...
            <div className="flex justify-center items-center py-2 md:col-span-1 md:py-0 md:pb-2">
              <button
                ...
                title="Swap cities"
                className={`flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300 transition-all duration-500 hover:bg-white/10 hover:border-white/20 hover:text-white ${
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3 items-end">
            ...
            {/* Empty space filler for alignment on desktop */}
      ...
      {submittedParams && processedResults.length > 0 && (
        <div className="flex flex-col gap-4">
          {/* Results Bar with Sort Controls */}
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <div className="flex flex-col items-center px-4 w-28 relative">
                      ...
                      <div className="w-full h-[2px] bg-white/10 relative">
                        <div className="absolute right-0 top-1/2 h-1.5 w-1.5 -translate-y-1/2 rounded-full bg-blue-500" />
                      </div>
