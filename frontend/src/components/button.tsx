  ...
  return (
    <button
      className={clsx(
        ...
        // Primary variant: Vibrant orange/amber gradient
        variant === "primary" &&
          "bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-[0_4px_20px_rgba(249,115,22,0.25)] hover:from-orange-400 hover:to-amber-400 hover:shadow-[0_4px_25px_rgba(245,158,11,0.4)] hover:-translate-y-[1px]",
